...
// Default positions
// CardDraws
#define BJ_DEFAULT_PLAYER_POS gengine::Vertex(3.3*gengine::glb::scene.width/8, 3.4*gengine::glb::scene.height/8.0, DRAW_Z_BASE)
#define BJ_DEFAULT_OPPONENT_POS gengine::Vertex(3.3*gengine::glb::scene.width/8, gengine::glb::scene.height/8.0, DRAW_Z_BASE)
// Floater card
#define BJ_DEFAULT_FLOATER_POS gengine::Vertex(gengine::glb::scene.width/4.0f, gengine::glb::scene.height/6.0f, HAND_Z_BASE)
// Deck & discard
...
#define BJ_DEFAULT_SELECTOR_POS gengine::Vertex(gengine::glb::scene.width/2.0f, gengine::glb::scene.height/2.0f, SELECTOR_Z_BASE)

// Selection offset
#define BJ_SELECT_OFFSET gengine::Vertex(0, 5, 0)
#define BJ_SELECTOR_OFFSET gengine::Vertex(0, 5, 0)
// Selection pathing
...
#define BJ_SHAKE_FLOATER gengine::GENG_Shake::FLOATY, 3.0, -1, 2.0, false