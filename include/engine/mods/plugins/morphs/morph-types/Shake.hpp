...
namespace gfx {
    ...
    protected:
        ...
        static void shake_random(gan::Transform2D& tref);
        void shake_circular(gan::Transform2D &tref, const gan::LayerState &time) const;
        void shake_floaty(gan::Transform2D &tref, const gan::LayerState &time) const;
        void shake_side(gan::Transform2D &tref, const gan::LayerState &time) const;
