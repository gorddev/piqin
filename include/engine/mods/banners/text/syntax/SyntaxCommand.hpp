...
namespace gan {
    ...
    inline void syntx_verif_blank(std::vector<str_subview>, SyntaxInfo&) { } // NOLINT(*-unnecessary-value-param)
    inline void syntx_update_blank(SyntaxInfo&) { }
     ...
     */
    using SyntaxVerifier = void (*)(std::vector<str_subview>, SyntaxInfo& out);
    class SyntaxCommand {
    ...
    struct SyntaxHighlight {
        ...
        SyntaxHighlight(hstring key, SyntaxUpdate update) : key(std::move(key)), update(update) {}
    };
}
