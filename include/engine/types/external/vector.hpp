/** vector.hpp
 * An implementation of `vector` (a vector with a small
...
namespace gch
{
...
#ifdef GCH_LIB_CONCEPTS
  requires concepts::vector::Allocator<Allocator>
#endif
...
#ifdef GCH_LIB_CONCEPTS
  requires concepts::vector::AllocatorFor<Allocator, T>
#endif
  class vector;
  ...
  public:
    ...
    using empty_vector = vector<value_type, 0, allocator_type>;
    ...
    //        while instantiating a vector, and attribute the mistake
    ...
    static constexpr
    unsigned
    ideal_buffer = ideal_total - sizeof (empty_vector);

    static_assert (sizeof (empty_vector) != 0,
                   "Empty `vector` should not have size 0.");

    static_assert (ideal_buffer < ideal_total,
                   "Empty `vector` is larger than ideal_total.");
...
//  vector_iterator            (void)                             = impl;
    ...
    constexpr explicit
    vector_iterator (const Pointer& p) noexcept
      : m_ptr (p)
    { }
    ...
    vector_iterator (const vector_iterator<U, D>& other) noexcept
      : m_ptr (other.base ())
    { }
  ...
  constexpr
  bool
  operator== (const vector_iterator<PointerLHS, DifferenceTypeLHS>& lhs,
              const vector_iterator<PointerRHS, DifferenceTypeRHS>& rhs)
  ...
  constexpr
  bool
  operator== (const vector_iterator<Pointer, DifferenceType>& lhs,
              const vector_iterator<Pointer, DifferenceType>& rhs)
    noexcept (noexcept (lhs.base () == rhs.base ()))
    requires requires { { lhs.base () == rhs.base () } -> std::convertible_to<bool>; }
  {
    return lhs.base () == rhs.base ();
  ...
  bool
  operator== (const vector_iterator<PointerLHS, DifferenceTypeLHS>& lhs,
              const vector_iterator<PointerRHS, DifferenceTypeRHS>& rhs) noexcept
  {
    return lhs.base () == rhs.base ();
  }
  ...
  bool
  operator== (const vector_iterator<Pointer, DifferenceType>& lhs,
              const vector_iterator<Pointer, DifferenceType>& rhs) noexcept
  {
    return lhs.base () == rhs.base ();
  }
  ...
  constexpr
  DifferenceType
  operator- (const vector_iterator<PointerLHS, DifferenceType>& lhs,
             const vector_iterator<PointerRHS, DifferenceType>& rhs) noexcept
  {
  ...
  template <typename Pointer, typename DifferenceType>
  constexpr
  vector_iterator<Pointer, DifferenceType>
  operator+ (DifferenceType n, const vector_iterator<Pointer, DifferenceType>& it) noexcept
  {
    return it + n;
  }
...
//    allocator_interface (const allocator_interface&)                     = impl;
      ...
      struct is_vector_iterator<vector_iterator<Ts...>>
        : std::true_type
      { };
      ...
      struct is_contiguous_iterator
        : bool_constant<
            ...
            ||  is_vector_iterator<InputIt>::value
#ifdef GCH_LIB_CONCEPTS
...
#else
        std::fprintf (stderr, "[gch::vector] The specified range is too long.");
        std::abort ();
#endif
      }
#endif
    ...
    public:
      ...
      vector_data_base            (void)                              = default;
      vector_data_base            (const vector_data_base&)     = default;
      vector_data_base            (vector_data_base&&) noexcept = default;
      vector_data_base& operator= (const vector_data_base&)     = default;
      vector_data_base& operator= (vector_data_base&&) noexcept = default;
      ~vector_data_base           (void)                              = default;
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_data_ptr (vector_data_base& other) noexcept
      {
        using std::swap;
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_capacity (vector_data_base& other) noexcept
      {
        using std::swap;
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_size (vector_data_base& other) noexcept
      {
        using std::swap;
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap (vector_data_base& other) noexcept
      {
        using std::swap;
        swap (m_data_ptr, other.m_data_ptr);
        swap (m_capacity, other.m_capacity);
    ...
    class vector_data
      : public vector_data_base<Pointer, SizeT>
    {
    public:
      vector_data            (void)                         = default;
      vector_data            (const vector_data&)     = delete;
      vector_data            (vector_data&&) noexcept = delete;
      vector_data& operator= (const vector_data&)     = delete;
      vector_data& operator= (vector_data&&) noexcept = delete;
      ~vector_data           (void)                         = default;
    ...
    class GCH_EMPTY_BASE vector_data<Pointer, SizeT, T, 0>
      : public vector_data_base<Pointer, SizeT>
    {
    public:
      vector_data            (void)                         = default;
    ...
    protected:
...
#else
            vector_adl::is_nothrow_swappable<T>::value
#endif
          >
      { };
...
#else
        std::fprintf (stderr, "[gch::vector] The requested index was out of range.\n");
        std::abort ();
#endif
      }
      ...
      throw_allocation_size_error (void)
      {
        ...
        std::fprintf (
          stderr,
          "[gch::vector] The required allocation exceeds the maximum size.\n");
        std::abort ();
#endif
      }
      ...
      GCH_NODISCARD GCH_CPP14_CONSTEXPR
      ptr
      ptr_cast (const vector_iterator<cptr, diff_ty>& it) noexcept
      {
...
//      ~heap_temporary           (void)                      = impl;
    ...
    protected:
      ...
      GCH_CPP20_CONSTEXPR
      void
      overwrite_existing_elements (vector_base<Allocator, N>&& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      copy_assign_equal_or_non_propagated_allocators (const vector_base<Allocator, N>& other)
      {
        assign_with_range (
          other.begin_ptr (),
          other.end_ptr (),
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      copy_assign_unequal_and_propagated_allocators (const vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      copy_assign (const vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_pointer (vector_base<Allocator, N>& other) noexcept
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_equal_or_non_propagated_allocators (vector_base<Allocator, N>& other)
      {
        assign_with_range (
          std::make_move_iterator (other.begin_ptr ()),
          std::make_move_iterator (other.end_ptr ()),
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_unequal_and_propagated_allocators (vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_equal_allocators (vector_base& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_equal_allocators (vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_unequal_allocators (vector_base& other)
      {
        return move_assign_pointer (other);
      }
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign_unequal_allocators (vector_base<Allocator, N>& other)
      {
        if (other.has_allocation () && InlineCapacity < other.get_capacity ())
          return move_assign_pointer (other);
        else
      ...
      GCH_CPP20_CONSTEXPR
      vector_base&
      move_assign (vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      move_initialize (vector_base&& other) noexcept
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      move_initialize (vector_base<Allocator, LessEqualI>&& other)
      ...
      GCH_CPP20_CONSTEXPR
      void
      move_initialize (vector_base<Allocator, GreaterI>&& other)
      {
    ...
    public:
//    vector_base            (void)                         = impl;
      vector_base            (const vector_base&)     = delete;
      vector_base            (vector_base&&) noexcept = delete;
      vector_base& operator= (const vector_base&)     = delete;
      vector_base& operator= (vector_base&&) noexcept = delete;
//    ~vector_base           (void)                         = impl;

      GCH_CPP20_CONSTEXPR
      vector_base (void) noexcept
      {
        set_default ();
      }
      ...
      GCH_CPP20_CONSTEXPR
      vector_base (bypass_tag, const vector_base<Allocator, I>& other, const A& alloc)
        : alloc_interface (alloc)
      {
        if (InlineCapacity < other.get_size ())
        {
      ...
      template <unsigned I>
      GCH_CPP20_CONSTEXPR
      vector_base (bypass_tag, const vector_base<Allocator, I>& other)
        : vector_base (bypass, other, static_cast<const alloc_interface &> (other))
      {}

      template <unsigned I>
      GCH_CPP20_CONSTEXPR
      vector_base (bypass_tag, vector_base<Allocator, I>&& other)
        noexcept (std::is_nothrow_move_constructible<value_ty>::value
      ...
      template <unsigned I, typename A = alloc_ty,
                typename std::enable_if<allocators_always_equal<A>::value>::type * = nullptr>
      GCH_CPP20_CONSTEXPR
      vector_base (bypass_tag, vector_base<Allocator, I>&& other, const alloc_ty&)
        noexcept (noexcept (vector_base (bypass, std::move (other))))
        : vector_base (bypass, std::move (other))
      { }

      template <unsigned I, typename A = alloc_ty,
                typename std::enable_if<! allocators_always_equal<A>::value>::type * = nullptr>
      GCH_CPP20_CONSTEXPR
      vector_base (bypass_tag, vector_base<Allocator, I>&& other, const alloc_ty& alloc)
        : alloc_interface (alloc)
      {
      ...
      GCH_CPP20_CONSTEXPR explicit
      vector_base (const alloc_ty& alloc) noexcept
        : alloc_interface (alloc)
      {
        set_default ();
      }
      ...
      GCH_CPP20_CONSTEXPR
      vector_base (size_ty count, const alloc_ty& alloc)
        : alloc_interface (alloc)
      {
        if (InlineCapacity < count)
        {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base (size_ty count, const value_ty& val, const alloc_ty& alloc)
        : alloc_interface (alloc)
      {
        if (InlineCapacity < count)
        {
      ...
      GCH_CPP20_CONSTEXPR
      vector_base (size_ty count, Generator& g, const alloc_ty& alloc)
        : alloc_interface (alloc)
      {
        if (InlineCapacity < count)
        {
...
#endif
      GCH_CPP20_CONSTEXPR
      vector_base (InputIt first, InputIt last, std::input_iterator_tag,
...
#endif
      GCH_CPP20_CONSTEXPR
      vector_base (ForwardIt first, ForwardIt last, std::forward_iterator_tag,
                         const alloc_ty& alloc)
        : alloc_interface (alloc)
      {
    ...
    protected:
      ...
      insert_range (ptr pos, InputIt first, InputIt last, std::input_iterator_tag)
      {
        ...
        using iterator_cat = typename std::iterator_traits<InputIt>::iterator_category;
        vector_base tmp (first, last, iterator_cat { }, allocator_ref ());
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_elements_equal_or_non_propagated_allocators (vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_elements_unequal_and_propagated_allocators (vector_base<Allocator, N>& r) noexcept
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_elements_unequal_and_propagated_allocators (vector_base<Allocator, N>& r)
      {
        if (r.get_size () < get_size ())
          return r.swap_elements_unequal_and_propagated_allocators (*this);
      ...
      template <unsigned N, typename A = alloc_ty,
                typename std::enable_if<allocators_always_equal<A>::value>::type * = nullptr>
      void
      swap_elements (vector_base<Allocator, N>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_unequal_and_non_propagated_allocators (vector_base<Allocator, N>& other)
      {
        assert (
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_equal_or_propagated_allocators (vector_base& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap_equal_or_propagated_allocators (vector_base<Allocator, LessEqualI>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap (vector_base<Allocator, GreaterI>& other)
      {
      ...
      GCH_CPP20_CONSTEXPR
      void
      swap (vector_base<Allocator, LessEqualI>& other)
      {
    ...
    private:
      vector_data<ptr, size_type, value_ty, InlineCapacity> m_data;
    };
...
#endif
  class vector
    : private detail::vector_base<Allocator, InlineCapacity>
  {
    using base = detail::vector_base<Allocator, InlineCapacity>;
  ...
  public:
...
#ifdef GCH_LIB_CONCEPTS
    requires concepts::vector::AllocatorFor<SameAllocator, SameT>
#endif
    friend class vector;
    ...
    using iterator               = vector_iterator<pointer, difference_type>;
    using const_iterator         = vector_iterator<const_pointer, difference_type>;
  ...
  private:
    static constexpr
    bool
    Destructible = concepts::vector::Destructible<value_type>;

    static constexpr
    bool
    MoveAssignable = concepts::vector::MoveAssignable<value_type>;

    static constexpr
    bool
    CopyAssignable = concepts::vector::CopyAssignable<value_type>;

    static constexpr
    bool
    MoveConstructible = concepts::vector::MoveConstructible<value_type>;

    static constexpr
    bool
    CopyConstructible = concepts::vector::CopyConstructible<value_type>;

    static constexpr
    bool
    Swappable = concepts::vector::Swappable<value_type>;

    static constexpr
    bool
    DefaultInsertable = concepts::vector::DefaultInsertable<value_type, vector,
                                                                  allocator_type>;

    static constexpr
    bool
    MoveInsertable = concepts::vector::MoveInsertable<value_type, vector,
                                                            allocator_type>;

    static constexpr
    bool
    CopyInsertable = concepts::vector::CopyInsertable<value_type, vector,
                                                            allocator_type>;

    static constexpr
    bool
    Erasable = concepts::vector::Erasable<value_type, vector, allocator_type>;
    ...
    struct EmplaceConstructible
    {
      static constexpr
      bool
      value = concepts::vector::EmplaceConstructible<value_type, vector,
                                                           allocator_type, Args...>;
    };
  ...
  public:
...
#endif
    GCH_CPP20_CONSTEXPR
    vector (size_type count, Generator g)
      : vector (count, g, allocator_type ())
    { }
...
#endif
    GCH_CPP20_CONSTEXPR
    vector (size_type count, Generator g, const allocator_type& alloc)
      : base (count, g, alloc)
    { }
    ...
    vector (std::initializer_list<value_type> init)
      ...
      requires EmplaceConstructible<const_reference>::value
           &&  concepts::DefaultConstructible<allocator_type>
#endif
      : vector (init.begin (), init.end (), allocator_type ())
    { }
...
#endif
    GCH_CPP20_CONSTEXPR explicit
    vector (const vector<T, I, Allocator>& other)
      : base (base::bypass, other)
    { }
...
#endif
    GCH_CPP20_CONSTEXPR explicit
    vector (vector<T, I, Allocator>&& other)
...
#endif
    GCH_CPP20_CONSTEXPR
    vector (const vector<T, I, Allocator>& other, const allocator_type& alloc)
      : base (base::bypass, other, alloc)
    { }
...
#endif
    GCH_CPP20_CONSTEXPR
    vector (vector<T, I, Allocator>&& other, const allocator_type& alloc)
      : base (base::bypass, std::move (other), alloc)
    { }
    ...
    GCH_CPP20_CONSTEXPR
    void
    assign (const vector<T, I, Allocator>& other)
    {
      base::copy_assign (other);
    }
    ...
    GCH_CPP20_CONSTEXPR
    void
    assign (vector<T, I, Allocator>&& other)
...
#else
                    &&  detail::vector_adl::is_nothrow_swappable<value_type>::value
#endif
                     )
                 ||  InlineCapacity == 0
                  )
    ...
    GCH_CPP20_CONSTEXPR
    void
    swap (vector<T, I, Allocator>& other)
#ifdef GCH_LIB_CONCEPTS
      requires (MoveInsertable && MoveAssignable && Swappable)
           ||  (  (  std::is_same<std::allocator<value_type>, Allocator>::value
                 ||  std::allocator_traits<Allocator>::propagate_on_container_swap::value
    ...
    GCH_CPP20_CONSTEXPR
    vector&
    append (const vector<T, I, Allocator>& other)
#ifdef GCH_LIB_CONCEPTS
      requires CopyInsertable
#endif
    {
    ...
    GCH_CPP20_CONSTEXPR
    vector&
    append (vector<T, I, Allocator>&& other)
#ifdef GCH_LIB_CONCEPTS
      requires MoveInsertable
#endif
    {
  ...
  bool
  operator== (const vector<T, InlineCapacityLHS, Allocator>& lhs,
              const vector<T, InlineCapacityRHS, Allocator>& rhs)
  {
  ...
  inline GCH_CPP20_CONSTEXPR
  bool
  operator== (const vector<T, InlineCapacity, Allocator>& lhs,
              const vector<T, InlineCapacity, Allocator>& rhs)
  {
    return lhs.size () == rhs.size () && std::equal (lhs.begin (), lhs.end (), rhs.begin ());
  }
  ...
  inline GCH_CPP20_CONSTEXPR
  void
  swap (vector<T, InlineCapacity, Allocator>& lhs,
        vector<T, InlineCapacity, Allocator>& rhs)
    noexcept (noexcept (lhs.swap (rhs)))
#ifdef GCH_LIB_CONCEPTS
    requires concepts::MoveInsertable<T, vector<T, InlineCapacity, Allocator>, Allocator>
  ...
  inline GCH_CPP20_CONSTEXPR
  void
  swap (vector<T, InlineCapacityLHS, Allocator>& lhs,
        vector<T, InlineCapacityRHS, Allocator>& rhs)
    noexcept (noexcept (lhs.swap (rhs)))
#ifdef GCH_LIB_CONCEPTS
    requires concepts::MoveInsertable<T, vector<T, InlineCapacityLHS, Allocator>, Allocator>
          && concepts::MoveAssignable<T>
          && concepts::Swappable<T>
#endif
  {
  ...
  inline GCH_CPP20_CONSTEXPR
  typename vector<T, InlineCapacity, Allocator>::size_type
  erase (vector<T, InlineCapacity, Allocator>& v, const U& value)
  {
  ...
  inline GCH_CPP20_CONSTEXPR
  typename vector<T, InlineCapacity, Allocator>::size_type
  erase_if (vector<T, InlineCapacity, Allocator>& v, Pred pred)
  {
    const auto original_size = v.size ();
  ...
  template <typename T, unsigned InlineCapacity, typename Allocator>
  constexpr
  typename vector<T, InlineCapacity, Allocator>::iterator
  begin (vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.begin ();
  }
  ...
  template <typename T, unsigned InlineCapacity, typename Allocator>
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_iterator
  begin (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.begin ();
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_iterator
  cbegin (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return begin (v);
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::iterator
  end (vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.end ();
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_iterator
  end (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.end ();
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_iterator
  cend (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return end (v);
  }
  ...
  template <typename T, unsigned InlineCapacity, typename Allocator>
  constexpr
  typename vector<T, InlineCapacity, Allocator>::reverse_iterator
  rbegin (vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.rbegin ();
  }
  ...
  template <typename T, unsigned InlineCapacity, typename Allocator>
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_reverse_iterator
  rbegin (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.rbegin ();
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_reverse_iterator
  crbegin (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return rbegin (v);
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::reverse_iterator
  rend (vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.rend ();
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_reverse_iterator
  rend (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.rend ();
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_reverse_iterator
  crend (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return rend (v);
  }
  ...
  constexpr
  typename vector<T, InlineCapacity, Allocator>::size_type
  size (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.size ();
  }
  ...
  typename std::common_type<
    ...
    typename std::make_signed<
      typename vector<T, InlineCapacity, Allocator>::size_type>::type>::type
  ssize (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
  ...
  GCH_NODISCARD constexpr
  bool
  empty (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.empty ();
  }
  ...
  template <typename T, unsigned InlineCapacity, typename Allocator>
  constexpr
  typename vector<T, InlineCapacity, Allocator>::pointer
  data (vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.data ();
  }
  ...
  template <typename T, unsigned InlineCapacity, typename Allocator>
  constexpr
  typename vector<T, InlineCapacity, Allocator>::const_pointer
  data (const vector<T, InlineCapacity, Allocator>& v) noexcept
  {
    return v.data ();
  }
  ...
  vector (InputIt, InputIt, Allocator = Allocator ())
    -> vector<typename std::iterator_traits<InputIt>::value_type, InlineCapacity, Allocator>;
