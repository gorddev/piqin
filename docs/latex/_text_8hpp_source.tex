...
\DoxyCodeLine{00021\ \ \ \ \ \ \ \ \ gch::vector<SDL\_Vertex>\ vertices;}
...
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ \ \ \ \ gch::vector<FontChar>\ buffer;}
...
\DoxyCodeLine{00080\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0,\ k\ =\ 0;\ i\ <\ buffer.size();\ i++,\ k++)\ \{}
